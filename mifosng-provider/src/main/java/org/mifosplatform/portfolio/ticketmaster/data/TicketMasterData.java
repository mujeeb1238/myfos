...
public class TicketMasterData {
	...
	public TicketMasterData(Long id, String priority, String status,
			int assignedTo, LocalDate ticketDate,String lastComment,String problemDescription,String userName) {
	...
	public TicketMasterData(Long id, String statusCode, String statusDesc) {
		 this.id=id;
	...
	public void setStatusData(List<TicketMasterData> closedStatusdata) {
		
		this.statusType=closedStatusdata;
	}
