...
public interface PortfolioApiDataBillingConversionService {
	...
	AddressCommand convertJsonToAddressCommand(Object object, Long clientId,String jsonRequestBody);

	OneTimeSaleCommand convertJsonToSalesCommand(Object object,	String jsonRequestBody);
	
	EmployeeCommand convertJsonToEmployeeCommand(Object object, String jsonRequestBody);
	
	InventoryItemDetailsCommand convertJsonToItemDetailsCommand(Object object,String jsonRequestBosy);
